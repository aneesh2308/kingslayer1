      ...
      >
        ...
        <View style={styles.list}>
          ...
          >
            ...
            <TouchableOpacity onPress={()=>{props.navigation.navigate("JoinClass")}}><Text style={{ fontSize: 12, color: "#E72C83", fontWeight: "700" }}>Join Session</Text></TouchableOpacity>
          </View>
        </View>
        {/* ---------------------------- section 1 --------------------------------------- */}
        ...
        <View style={styles.list}>
          <TouchableOpacity
            onPress={() => props.navigation.navigate("UpcomingLec")}
          >
            <View style={styles.listleftcontent}>
              <Text
        ...
        <View style={styles.list}>
          <TouchableOpacity
            onPress={() => props.navigation.navigate("RecordedLec")}
          >
            <View style={styles.listleftcontent}>
              <Text
                style={{ fontSize: 14, color: "#535B65", fontWeight: "700" }}
        ...
        <View style={styles.list}>
          <TouchableOpacity
            onPress={() => props.navigation.navigate("PayFeesInvoice")}
          >
            <View style={styles.listleftcontent}>
              <Text
                style={{ fontSize: 14, color: "#535B65", fontWeight: "700" }}
        ...
        <View style={styles.list}>
          <TouchableOpacity
            onPress={() => props.navigation.navigate("McqTests")}
          >
            <View style={styles.listleftcontent}>
              <Text
                style={{ fontSize: 14, color: "#535B65", fontWeight: "700" }}
        ...
        <View style={styles.list}>
          <TouchableOpacity
            onPress={() => props.navigation.navigate("ContactUsList")}
          >
            <View style={styles.listleftcontent}>
              <Text
                style={{ fontSize: 14, color: "#535B65", fontWeight: "700" }}
...
export default inject("store")(observer(MyCollege));
