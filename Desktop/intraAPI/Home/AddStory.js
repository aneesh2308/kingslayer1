...
// Geocoder.init("c9bcd2bee9e082ea94bc3b7cf2282391c5ef496c");
      ...
      const uploadImage = async () => {
        ...
        const taskCompleted = () => {
            task.snapshot.ref.getDownloadURL().then((snapshot)=>{
                ...
                fetch(`${apiURL}/user/story`, requestOptions)
...
export default inject("store")(observer(AddStory));
