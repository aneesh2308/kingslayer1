...
import AssignmentsList from "../CustomLists/MyCollegeList/AssignmentsList";
...
React.useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <AssignmentsList navigation={props.navigation} />
      {/* -----------------------------Bottom TAb-------------------------------------- */}
    </View>
  );
};

export default inject("store")(observer(Assignment));
