...
import UpcomingLecList from "../CustomLists/MyCollegeList/UpcomingLecList";

const UpcomingLec = (props) => {
...
React.useEffect(() => {
  ...
  return (
    <View style={styles.container}>
      ...
      <UpcomingLecList navigation={props.navigation} />
    </View>
  );
};
export default inject("store")(observer(UpcomingLec));
