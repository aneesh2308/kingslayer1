...
const generatePDF = (ticket) => {
  ...
  var address;
  try{
      address = ticket.address.line1
        + ',' + ticket.address.line2 + ' ,' + ticket.address.city + ' ,' + ticket.address.state + ' ,' + ticket.address.country + ' ,' + ticket.address.pincode
  }catch (e) {
    console.log(e)
    address=''
  }
